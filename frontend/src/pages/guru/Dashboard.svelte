<script lang="ts">
	...
	import type { User, GuruDashboard, TilawahStatus } from "@lib/types";
	import { BookOpen, Users, Clock, CheckCircle, AlertCircle, ArrowRight, Play, BookMarked } from "lucide-svelte";
	...
	let { user, dashboard, tilawah, success, error }: Props = $props();
